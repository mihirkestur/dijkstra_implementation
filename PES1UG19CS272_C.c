...
void min_heapify(min_heap *input_heap, int index){
    ...
    if(smallest != index){
        ...
        heap_node *indexNode = input_heap->array_heap_nodes[index];

        input_heap->index_array[smallestNode->vertex] = index;
        input_heap->index_array[indexNode->vertex] = smallest;
...
void display_path(min_heap *input_heap, int vertex){
    ...
    int pos = input_heap->index_array[vertex];
